...
class AppPonto(tk.Tk):
    def __init__(self):
        ...
        self.style.configure("TLabel", background=BG_COLOR, foreground="#2C3E50", font=("Segoe UI", 10))
    ...
    def _init_login_ui(self):
        ...
        ttk.Label(self.frame, text="Usuário", font=("Segoe UI", 11, "bold")).pack(anchor="w", pady=(0, 5))
        self.ent_user = ttk.Entry(self.frame, width=30)
        self.ent_user.pack(pady=(0, 15), ipady=3)
        
        ttk.Label(self.frame, text="Senha", font=("Segoe UI", 11, "bold")).pack(anchor="w", pady=(0, 5))
        self.ent_pass = ttk.Entry(self.frame, show="*", width=30)
        self.ent_pass.pack(pady=(0, 15), ipady=3)
        ...
        self.btn_login = ttk.Button(self.frame, text="Conectar", command=self._do_login)
    ...
    def _init_main_ui(self):
        ...
        self.tree.tag_configure("positive", foreground="#1ABC9C", font=("Segoe UI", 10, "bold"))
        self.tree.tag_configure("negative", foreground="#E74C3C", font=("Segoe UI", 10, "bold"))
        self.tree.tag_configure("missing", background="#FFD2D2", foreground="#C0392B")
    ...
    def _fetch_and_display(self):
        ...
        self.lbl_status.config(text="Obtendo dados do espelho de ponto na Dixi...", foreground="blue")
    ...
    def _populate_table(self, data: List[MarcacaoDia]):
        ...
        if data:
            ...
            self.lbl_status.config(text=status_text, foreground="#2C3E50")
